...
const EnhancedInput = ({ type, value, onChange, maxLength = 200 }) => {
  ...
  return (
    <div className="mb-8">
      ...
      <div className={`relative transition-all duration-200 rounded-2xl bg-white border-2 ${
        isFocused ? 'border-gray-900 shadow-lg shadow-gray-900/5' : 'border-gray-100 hover:border-gray-200'
      }`}>
        <textarea
  ...
  return (
    <div className="mt-8">
      ...
      <button
        ...
        className={`w-full py-4 px-6 rounded-2xl font-semibold text-base transition-all duration-200 flex items-center justify-center space-x-2 ${
          isFormValid 
      ...
      <div className="p-6">
          ...
          <div>
            {hasSubmitted ? (
              ...
              <div>
                ...
                <EnhancedInput type="peak" value={peak} onChange={setPeak} />
                <EnhancedInput type="pit" value={pit} onChange={setPit} />
        ...
        {activeTab === 'streak' && (
          <div className="text-center">
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Streak tracker coming soon!</h2>
            <p className="text-gray-500">This feature is being built and will be available shortly.</p>
          </div>
        )}
      </div>
    </div>
